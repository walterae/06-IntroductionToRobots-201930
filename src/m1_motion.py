...
their colleagues, and Audrey Walters.
...
def run_test_go(robot):
    ...
    # DONE: 3. Implement this.
    # -------------------------------------------------------------------------
    go(robot,5,40,40) #Forwards
    time.sleep(2)
    go(robot,5,40,50) #Turn Right
    time.sleep(2)
    go(robot,5,50,40) #Turn Left
    time.sleep(2)
    go(robot,5, -40, -40) #Backwards
...
def challenge1(robot):
    ...
    go(robot,3,50,40) #Left
    time.sleep(2)
    go(robot,4,40,60) #Right
    time.sleep(2)
    # go(robot,3,50,40) #Left
    # time.sleep(2)
    # go(robot,3,50,40) #Right
    # time.sleep(2)
